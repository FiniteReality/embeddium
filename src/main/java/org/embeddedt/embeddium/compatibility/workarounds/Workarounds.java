package org.embeddedt.embeddium.compatibility.workarounds;

import org.embeddedt.embeddium.compatibility.environment.OSInfo;
import org.embeddedt.embeddium.compatibility.environment.probe.GraphicsAdapterInfo;
import org.embeddedt.embeddium.compatibility.environment.probe.GraphicsAdapterProbe;
import org.embeddedt.embeddium.compatibility.environment.probe.GraphicsAdapterVendor;
...
import static org.embeddedt.embeddium.Embeddium.MODNAME;
...
public class Workarounds {
    ...
    public static void init() {
        ...
        if (!workarounds.isEmpty()) {
            LOGGER.warn("Embeddium has attempted to apply one or more workarounds to prevent crashes or other issues on your system: [{}]",
                    workarounds.stream()
                            .map(Enum::name)
