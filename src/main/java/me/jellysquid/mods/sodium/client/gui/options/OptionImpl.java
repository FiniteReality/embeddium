    ...
    public static class Builder<S, T> {
        ...
        public OptionImpl<S, T> build() {
            if (this.id == null) {
                ...
                this.id = (OptionIdentifier<T>)OptionIdentifier.create("embeddium", "autogenerated/" + (this.name != null ? this.name.getString() : "null"), this.binding.getValue(this.storage.getData()).getClass());
                // FIXME enforce IDs
